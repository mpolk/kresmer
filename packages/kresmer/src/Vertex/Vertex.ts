 ...
 * -----------------------------------------------------------------------
 *                           Generic Vertex 
 * (as is may belong to an Area, and its descendants are used in Links)
 ***************************************************************************/
...
export default class Vertex {
    ...
    */
    ...
    attachedVertices = new Set<Vertex>();
    ...
    get prevNeighbour(): Vertex|undefined {return this._vertexNumber ? this.link.vertices[this._vertexNumber-1] : undefined}
    get nextNeighbour(): Vertex|undefined {return this._vertexNumber < this.link.vertices.length ? this.link.vertices[this._vertexNumber+1] : undefined}
    ...
    private alignEndpoint(neighbor: Vertex, mode: VertexAlignmentMode): LinkVertexAnchor|null
    {
    ...
    private alignBundleEndpoint(mode: VertexAlignmentMode): LinkVertexAnchor|null
    {
        ...
        const verticesAttachedHere: Vertex[] = [];
    ...
    private alignOnBundle(outOfBundleNeighbour: Vertex): LinkVertexAnchor|null
    {
    ...
    private alignBetweenTwoPositions(predecessor: Vertex, successor: Vertex): LinkVertexAnchor|null
    {
    ...
    private alignBetweenConnectionAndPosition(connected: Vertex, positioned: Vertex): LinkVertexAnchor|null
    {
...
export type LinkVertexSpec = {vertex: Vertex}|{linkID: number, vertexNumber: number};
...
export class VerticesMoveOp extends EditorOperation {
    ...
    private oldAnchors = new Map<Vertex, LinkVertexAnchor>();
    private newAnchors = new Map<Vertex, LinkVertexAnchor>();
