...
- You may export you drawing to SVG-format, which is understood by many desktop applications and browsers. At least it should be. Unfortunately some reasonable complex Kresmer drawings may produce the SVG that is too heavy for such a popular SVG editors as Inkscape or LibreOffice Draw. At the same time all modern browsers perfectly render the SVG-graphics generated by Kresmer.
